...
============================
1. "whole milk" is the single most purchased item (2513 transactions),
   appearing in roughly 25.6% of all baskets.
...
3. Basket sizes are small and right-skewed: mean 4.41 items,
   with 70.8% of baskets containing 1-5 items.
4. Max basket size is 32 items — large multi-item baskets are rare,
